...
def store_events_ana_data(file_name, group_name, events_df, events_dict):
  ...
  events_df.loc[events_dict['id'], 'track0_length'] = events_dict['track0_length']
  ...
  events_df.loc[events_dict['id'], 'track1_length'] = events_dict['track1_length']
  ...
  events_df.loc[events_dict['id'], 'track2_length'] = events_dict['track2_length']
